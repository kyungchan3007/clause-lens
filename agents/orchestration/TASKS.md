...
| TASK-002 | S3 Presigned URL 연동·직접 업로드 | [capture-import](../intent/features/capture-import.md) | [0018](../intent/specs/0018-uploads-presign.md) | Claude | **in-progress** (백엔드 #15/PR#59 **머지 완료**·MinIO 실측 / 앱 RN 연동은 후속) | TASK-001 |
